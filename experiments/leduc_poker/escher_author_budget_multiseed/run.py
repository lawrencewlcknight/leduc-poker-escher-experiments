"""CLI entry point for the author-budget Leduc poker ESCHER experiment."""
...
def _build_arg_parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(description="Run the author-budget Leduc poker ESCHER multi-seed validation.")
